...
from api.routes import admin_v2 as admin, auth, curriculum, manual_editor, programs, rooms, sections, solver, solver_observability, subjects, teachers, timetable
...
api_router.include_router(solver_observability.router, prefix="/solver", tags=["solver-observability"], dependencies=_protected)
